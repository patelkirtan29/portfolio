...
export default function ContactPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col justify-center gap-4 px-4 py-8">
      ...
      <section
        ...
        className="flex flex-col gap-2 rounded-lg border border-foreground/10 bg-surface p-4"
      >
        <a
          href={`mailto:${EMAIL}`}
          className="font-mono text-lg text-accent-primary underline underline-offset-4"
        >
          {EMAIL}
        </a>
        <div className="flex items-center gap-2">
          <button
            ...
            className="rounded-md border border-foreground/20 px-2 py-1 text-sm text-foreground hover:border-accent-primary"
          >
            Copy email
          </button>
        ...
        <div className="mt-2 flex flex-col gap-1">
          {SOCIAL_LINKS.map((link) => (
            <a
              ...
              className="text-sm text-foreground/70 underline underline-offset-4 hover:text-accent-primary"
            >
              {link.label}
            </a>
          ))}
      ...
      <form
        ...
        className="flex flex-col gap-3 rounded-lg border border-foreground/10 bg-surface p-4"
      >
        ...
        <button
          type="submit"
          className="self-start rounded-md bg-accent-primary px-3 py-1.5 font-display text-background hover:opacity-90"
        >
          Send
        </button>
